...
WebUI.waitForElementVisible(findTestObject('ObjSpy/Login Page/txt_Login failed'), 0)

WebUI.verifyElementVisible(findTestObject('ObjSpy/Login Page/txt_Login failed'))

WebUI.verifyElementVisible(findTestObject('ObjSpy/Login Page/txtField_username'))

WebUI.verifyElementVisible(findTestObject('ObjSpy/Login Page/txtField_password'))
